...
contract FOMOARMY is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0x0148FBE13EE35D4Ada5Bb79A4c089C7E3913fC83);


    uint256 public _buyTax = 6; //Buy fee
    uint256 public _sellTax = 6; // sell fee


    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 46000000000 * 10**_decimals; // Total supply
    string private constant _name = unicode"FOMOARMY";  // Name
    string private constant _symbol = unicode"FOMO24"; // Symbol
    uint256 public _taxSwapThreshold= 50000000 * 10**_decimals;
    uint256 public maxWalletLimit = 3680000000 * 10 ** decimals();
